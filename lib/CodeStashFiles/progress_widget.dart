...
class ProgressPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) async {
    ...
    Paint inActive = new Paint()
      ...
      ..style = PaintingStyle.stroke
      ..strokeWidth = 8;
    canvas.drawArc(Rect.fromCircle(center: center1, radius: 40), 0, 180, false, inActive);

    canvas.drawArc(Rect.fromCircle(center: center1, radius: 40), -90 * pi / 180, value * pi / 180, false, active);
  }
